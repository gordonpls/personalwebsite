...
export const ChinesePhrase = ({ chinese }: { chinese: Chinese | null }) => {
    ...
    return (
        <div className="bg-base-100 border border-base-300 rounded-2xl p-4 md:p-5 text-center">
            <p className="text-[10px] uppercase tracking-[0.3em] text-base-content/70 font-semibold mb-2">Phrase of the day</p>
            <div className="flex items-center justify-center gap-2">
                <p
                    className="text-2xl md:text-3xl font-semibold text-base-content"
            ...
            <p className="text-sm md:text-base text-base-content/60 italic mt-1 tracking-wide">{chinese.pinyin}</p>
            <p className="text-xs md:text-sm text-base-content/70 mt-1.5 max-w-md mx-auto">{chinese.translation}</p>
        </div>
    );
};
