...
const PARAGRAPHS = [
    "People who know me well often tell me that I have optimistic views. I think this quality has developed over time. It started with the values I was raised with and grew through the people who have supported me. In time, it became tied to a belief I hold closely: even when life takes sharp, unexpected turns, the good can still outweigh the terrible. This optimism has expanded my gratitude for life and become a standard for the way I carry myself, treat others, and recognize the gift of each day.",
    "Much of that foundation comes from my parents. Growing up, I watched them work tirelessly to create opportunities for our family. I also remember the warmth they brought into everything they did. My father approached his craft with focus and precision, while my mother showed me the importance of education and patience. Their example taught me perseverance, dedication, and the discipline to approach things with passion and meticulous planning. I've learned to show up prepared, stay curious, and take pride in doing things well. The lessons I first learned sitting in the corner of our family's restaurant continue to guide the goals I set and the effort I bring to them.",
    ...
    "The journey so far has given me a greater appreciation for where I come from and strengthened my conviction to build a future that reflects my ambition and dedication. Right now, that ambition is manifesting through the questions I find most intriguing: how money moves in finance, how systems work together in engineering, how people come together to build amazing things, and how technology constantly reshapes all three.",
    "I believe in bringing intention to my work, treating people with kindness, and remaining open to what each experience can teach me. I've also come to appreciate that everyone carries a story worth hearing. I enjoy sharing mine, and I'm always grateful when people take the time to listen. Those conversations create room for understanding, broaden perspective, and bring more humanity into this complex world.",
