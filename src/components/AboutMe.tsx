...
const PARAGRAPHS = [
    ...
    "Much of this foundation comes from my parents. Growing up, I watched them work tirelessly to create opportunities for our family. The warmth they brought into all of their actions remains in my heart. My father approached his craft with focus and precision, while my mother showed me the importance of education and patience. Their example taught me perseverance, dedication, and the discipline to approach things with passion and meticulous planning. By playing my part in the family business, I learned to show up prepared, stay curious, and take pride in doing things well. The memories I made in the corner of our family's restaurant became the earliest lessons, and they continue to guide the goals I set and the effort I bring to achieving them." ,
